...
void  BSP_Init (void)
{
    ...
    FLASH_Lock();
		...
		BERO_Check_Config();
			...
			//init PWM output
		TIM3_PWM_Init(9999, 143); //PWM frequence = 72*10^6/(9999+1)/(143+1) = 50HZ
		TIM2_PWM_Init(9999, 143);
		//TIM3_PWM_Init(199, 7199); //PWM frequence = 72*10^6/(7199+1)/(199+1) = 50HZ


		//DEBUG("\r\n wildfire ISO-MINI board emWin test \r\n");
