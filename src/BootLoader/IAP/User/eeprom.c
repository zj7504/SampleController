...
u16 VirtAddVarTab[NumbOfVar] = {0x1111, 0x2222, 0x3333 , 0x4444, 0x5555, 0x6666};
...
u16 EE_ReadVariable(u16 VirtAddress, u16* Data)
{
  ...
  PageStartAddress = (u32)(EEPROM_START_ADDRESS + (u32)(ValidPage * PAGE_SIZE_EEPROM));

  /* Get the valid Page end Address */
  Address = (u32)((EEPROM_START_ADDRESS - 2) + (u32)((1 + ValidPage) * PAGE_SIZE_EEPROM));
...
static u16 EE_VerifyPageFullWriteVariable(u16 VirtAddress, u16 Data)
{
  ...
  /* Get the valid Page start Address */
  Address = (u32)(EEPROM_START_ADDRESS + (u32)(ValidPage * PAGE_SIZE_EEPROM));

  /* Get the valid Page end Address */
  PageEndAddress = (u32)((EEPROM_START_ADDRESS - 2) + (u32)((1 + ValidPage) * PAGE_SIZE_EEPROM));
